exports.config = {
    ...
    before: function (capabilities, specs) {
        ...
        browser.execute( () => {
            ...
            window.failI7Test = function( name ) {
                window.i7TestFailed = true;

                if( name ) {
                    window.failedI7Test = name;
                }
            };

            window.passI7Test = function() {
                window.i7TestPassed = true;
            };

            window.resetTest = function() {
                // We'll have to keep track of both fail and pass states
                // to make sure that the test does anything
                window.i7TestPassed = false;
                window.i7TestFailed = false;
                window.failedI7Test = "";
            };
    ...
    afterTest: function (test) {
        /* uncomment to prevent the browser window closing when a test fails
        if( !test.passed ) {
            browser.debug();
        }
        */
